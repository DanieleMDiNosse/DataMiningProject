...
\caption{Distribuzione della silhouette su 500 set di dati random per il sottoinsieme 2. Media: 0.06; Deviazione Standard: 0.03. La linea arancione rappresenta la silhouette sui dati reali.}
\label{etichetta2}
\end{minipage}
\end{figure}

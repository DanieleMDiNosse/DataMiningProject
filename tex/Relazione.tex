...
\captionof{figure}{Alcune delle trasformazioni effettuate}
\end{center}
...
\captionof{figure}{Correlazione tra YearsInCurrentRole, YearInCurrManager e YearsSinceLastPromotion}
\end{center}
